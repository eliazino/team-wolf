angular
  .module('app')
  .controller('cardsCtrl', ['$scope', '$location', '$http', '$state', 'UserService', 'DTOptionsBuilder', '$rootScope', '$timeout',  cardsCtrl]);
	function cardsCtrl($scope, $location, $http, $state, UserService, DTOptionsBuilder, $rootScope, $timeout) {     
        if($rootScope.validate()){
            ...
            /* Get Outlets */
            var  url= UserService.apiRoot+'admin/get/cards/-';
            var data= {};
